...
do
  ...
  -- Toggle the Neotree file explorer
  vim.keymap.set('n', '<C-\\>', '<cmd>Neotree toggle<CR>')
  vim.keymap.set('i', '<C-\\>', '<cmd>Neotree toggle<CR>')

  -- Run the selected lines through makeParagraph.py to build a Shape Up paragraph
  vim.keymap.set('v', '<leader>mp', ':!python3 ~/gogs/code/shape_up_conversion/tools/makeParagraph.py<CR>', { desc = '[M]ake [P]aragraph' })
...
do
  ...
  require('cyberdream').setup {
    ...
    highlights = {
      ...
      Boolean = { fg = cyberdream_colors.purple, bg = 'NONE' },
      Statement = { fg = 'DarkBlue', bg = 'NONE' },
      Keyword = { fg = cyberdream_colors.purple, bg = 'NONE' },
